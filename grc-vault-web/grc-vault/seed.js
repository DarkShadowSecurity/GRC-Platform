...
async function seed() {
  ...
  const audits = [
    ...
    { name: "PCI DSS v4.0 Compliance Audit", framework: "PCI DSS", status: "Completed", scope: "Payment processing, cardholder data environment, network segmentation", auditor: "External: Coalfire", startDate: "2025-10-01", endDate: "2025-12-15", notes: "Full PCI DSS v4.0 assessment. SAQ D merchant level 2." },
