...
const GOV_ITEMS = [
  // ── POLICIES ──────────────────────────────────────────────────────────
  {t:"Information Security Policy",type:"Policy",fw:{"NIST CSF":["ID.GV-1"],"ISO 27001":["A.5.1.1","A.5.1.2"],"SOC 2":["CC1.1"],"HIPAA":["§164.308(a)(1)(i)"],"PCI DSS":["Req 12.1"],"GDPR":["Art.24"],"CMMC":["CA.L2-3.12.1"],"NIST 800-53":["PM-1","PL-1"]},reqs:["Management-approved information security policy document exists","Policy defines scope, objectives, and principles of information security","Roles and responsibilities for information security are defined","Policy is communicated to all employees and relevant external parties","Policy is reviewed at least annually or after significant changes"]},
  {t:"Access Control Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-1","PR.AC-4"],"ISO 27001":["A.9.1.1","A.9.1.2"],"SOC 2":["CC6.1","CC6.2"],"HIPAA":["§164.312(a)(1)"],"PCI DSS":["Req 7.1","Req 8.1"],"GDPR":["Art.32"],"CMMC":["AC.L2-3.1.1","AC.L2-3.1.2"],"NIST 800-53":["AC-1","AC-2","AC-3","AC-5","AC-6"]},reqs:["Least privilege principle is documented and enforced","Access provisioning and de-provisioning processes are defined","Periodic access reviews are conducted and documented","Privileged account management procedures are specified","Separation of duties requirements are documented"]},
  {t:"Data Classification Policy",type:"Policy",fw:{"ISO 27001":["A.8.2.1","A.8.2.2"],"SOC 2":["CC6.1"],"PCI DSS":["Req 3.1"],"GDPR":["Art.9"],"CMMC":["MP.L2-3.8.1"],"NIST 800-53":["RA-2","MP-3"]},reqs:["Data classification levels are defined with clear criteria","Labeling and handling requirements exist for each classification level","Data owners are assigned and documented for all data assets","Classification review process is defined and performed periodically","Procedures for reclassification and declassification are documented"]},
  {t:"Acceptable Use Policy",type:"Policy",fw:{"ISO 27001":["A.8.1.3"],"SOC 2":["CC1.1"],"PCI DSS":["Req 12.2"],"CMMC":["AT.L2-3.2.1"],"NIST 800-53":["PL-4"]},reqs:["Permitted and prohibited uses of organizational assets are defined","Employee acknowledgment records are maintained","Policy covers internet, email, social media, and personal device usage","Consequences for policy violations are specified","Policy is reviewed and updated at least annually"]},
  {t:"Privacy Policy & Notice",type:"Policy",fw:{"GDPR":["Art.12","Art.13","Art.14"],"HIPAA":["§164.312(c)(1)"],"SOC 2":["P1.1","P1.2"],"NIST 800-53":["PT-5","PT-1"]},reqs:["Privacy notice is publicly accessible and written in clear language","Legal basis for each data processing activity is documented","Data subject rights and how to exercise them are described","Data retention periods are specified for each data category","Contact details of the data protection officer or privacy team are provided"]},
  {t:"Encryption & Cryptography Policy",type:"Policy",fw:{"ISO 27001":["A.10.1.1","A.10.1.2"],"PCI DSS":["Req 3.5","Req 4.1"],"HIPAA":["§164.312(a)(2)(iv)","§164.312(e)(2)(ii)"],"GDPR":["Art.32"],"CMMC":["SC.L2-3.13.11"],"NIST 800-53":["SC-12","SC-13"]},reqs:["Approved cryptographic algorithms and minimum key lengths are specified","Key management lifecycle procedures are documented","Encryption requirements for data at rest and in transit are defined","Crypto key custodian roles and responsibilities are assigned","Policy mandates use of FIPS-validated or equivalent cryptographic modules"]},
  {t:"Physical Security Policy",type:"Policy",fw:{"ISO 27001":["A.11.1.1","A.11.1.2"],"HIPAA":["§164.310(a)(1)","§164.310(a)(2)(ii)"],"PCI DSS":["Req 9.1"],"CMMC":["PE.L2-3.10.1","PE.L2-3.10.2"],"NIST 800-53":["PE-1","PE-2","PE-3"]},reqs:["Physical security perimeters and secure areas are defined","Physical access control mechanisms are documented","Visitor management procedures are specified","Physical access logs are maintained and reviewed","Environmental controls for server rooms and data centers are documented"]},
  {t:"Network Security Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-5","PR.PT-4"],"ISO 27001":["A.13.1.1","A.13.1.3"],"PCI DSS":["Req 1.1","Req 1.2"],"CMMC":["SC.L2-3.13.1","SC.L2-3.13.6"],"NIST 800-53":["SC-7","SC-1","AC-4"]},reqs:["Network architecture diagram exists and is current","Firewall and router rule sets are documented and reviewed","Network segmentation requirements are defined","Default-deny rules are implemented at network boundaries","Network security controls are tested at least annually"]},
  {t:"Remote Access Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-3"],"ISO 27001":["A.6.2.2"],"PCI DSS":["Req 8.4"],"CMMC":["AC.L2-3.1.12","AC.L2-3.1.14"],"NIST 800-53":["AC-17","AC-1"]},reqs:["Approved remote access methods and technologies are specified","Multi-factor authentication is required for all remote access","VPN or encrypted tunnel requirements are documented","Remote session timeout and monitoring requirements are defined","Remote access authorization and revocation process is documented"]},
  {t:"Password & Authentication Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-1","PR.AC-7"],"ISO 27001":["A.9.3.1","A.9.4.3"],"HIPAA":["§164.308(a)(5)(ii)(D)"],"PCI DSS":["Req 8.2","Req 8.3"],"CMMC":["IA.L2-3.5.7","IA.L2-3.5.8"],"NIST 800-53":["IA-1","IA-5","IA-2"]},reqs:["Minimum password complexity and length requirements are specified","Account lockout thresholds and duration are defined","Multi-factor authentication requirements are documented","Password history and expiration rules are specified","Service account and shared credential management procedures exist"]},
  {t:"Change Management Policy",type:"Policy",fw:{"ISO 27001":["A.12.1.2","A.14.2.2"],"SOC 2":["CC8.1"],"PCI DSS":["Req 6.5"],"CMMC":["CM.L2-3.4.3","CM.L2-3.4.4"],"NIST 800-53":["CM-3","CM-4"]},reqs:["Change request, approval, and documentation process is defined","Impact analysis is required before changes are implemented","Rollback procedures are documented for all changes","Emergency change process is defined with post-implementation review","Change log is maintained with approver, date, and description"]},
  {t:"Vendor & Third-Party Management Policy",type:"Policy",fw:{"NIST CSF":["ID.SC-1","ID.SC-2"],"ISO 27001":["A.15.1.1","A.15.1.2"],"SOC 2":["CC9.1","CC9.2"],"GDPR":["Art.28"],"PCI DSS":["Req 12.8"],"NIST 800-53":["SR-1","SR-6","SA-9"]},reqs:["Vendor risk assessment process is documented","Security requirements are included in vendor contracts","Periodic vendor security reviews are conducted and documented","Vendor inventory with risk ratings is maintained","Data processing agreements exist for all vendors handling sensitive data"]},
  {t:"Data Retention & Disposal Policy",type:"Policy",fw:{"ISO 27001":["A.8.3.1","A.8.3.2"],"HIPAA":["§164.310(d)(2)(i)","§164.310(d)(2)(ii)"],"PCI DSS":["Req 3.1","Req 9.4"],"GDPR":["Art.5","Art.17"],"CMMC":["MP.L2-3.8.3"],"NIST 800-53":["SI-12","MP-6"]},reqs:["Retention periods are defined for each data type and legal basis","Approved data destruction methods are specified for each media type","Disposal certificates or proof of destruction are maintained","Automated retention enforcement mechanisms are documented","Exceptions process for extended retention is defined"]},
  {t:"Mobile Device & BYOD Policy",type:"Policy",fw:{"ISO 27001":["A.6.2.1"],"CMMC":["AC.L2-3.1.18","AC.L2-3.1.19"],"NIST 800-53":["AC-19","AC-18"]},reqs:["Approved mobile device types and operating systems are specified","Mobile device management (MDM) enrollment is required","Encryption requirements for mobile devices are defined","Remote wipe capability is documented and tested","BYOD acceptable use and data separation requirements are specified"]},
  {t:"Security Awareness & Training Policy",type:"Policy",fw:{"NIST CSF":["PR.AT-1","PR.AT-2"],"ISO 27001":["A.7.2.2"],"SOC 2":["CC1.4"],"HIPAA":["§164.308(a)(5)(i)"],"PCI DSS":["Req 12.6"],"CMMC":["AT.L2-3.2.1","AT.L2-3.2.2"],"NIST 800-53":["AT-1","AT-2","AT-3"]},reqs:["Annual security awareness training is mandatory for all employees","Training completion records are tracked and maintained","Role-based training is provided for privileged and technical staff","Phishing simulation exercises are conducted periodically","New hire security training is completed within 30 days of start date"]},
  {t:"Vulnerability Management Policy",type:"Policy",fw:{"NIST CSF":["PR.IP-12"],"ISO 27001":["A.12.6.1"],"PCI DSS":["Req 6.3","Req 11.3"],"CMMC":["SI.L2-3.14.1"],"NIST 800-53":["RA-5","SI-2"]},reqs:["Vulnerability scanning frequency and scope are defined","Risk-based remediation timelines are specified by severity level","Patch management process and SLAs are documented","Exception and risk acceptance process for unpatched vulnerabilities exists","Vulnerability scan results and remediation tracking are maintained"]},
  {t:"Audit Logging & Monitoring Policy",type:"Policy",fw:{"NIST CSF":["DE.CM-1","PR.PT-1"],"ISO 27001":["A.12.4.1","A.12.4.3"],"SOC 2":["CC7.1","CC7.2"],"HIPAA":["§164.312(b)"],"PCI DSS":["Req 10.1","Req 10.2"],"CMMC":["AU.L2-3.3.1","AU.L2-3.3.2"],"NIST 800-53":["AU-1","AU-2","AU-3","AU-12"]},reqs:["Auditable events and log contents are defined","Log retention periods and storage requirements are specified","Log integrity protection and tamper-detection mechanisms are defined","Log review frequency and responsible roles are assigned","Alerting thresholds and escalation procedures are documented"]},
  {t:"Configuration Management Policy",type:"Policy",fw:{"NIST CSF":["PR.IP-1"],"ISO 27001":["A.12.1.1"],"PCI DSS":["Req 2.1","Req 2.2"],"CMMC":["CM.L2-3.4.1","CM.L2-3.4.2"],"NIST 800-53":["CM-1","CM-2","CM-6"]},reqs:["Baseline configurations are established for all system types","Default credentials and unnecessary services must be removed or disabled","Configuration drift detection and remediation process is defined","Approved software and hardware inventories are maintained","Configuration change approval workflow is documented"]},
  {t:"System Maintenance Policy",type:"Policy",fw:{"NIST CSF":["PR.MA-1","PR.MA-2"],"ISO 27001":["A.11.2.4"],"CMMC":["MA.L2-3.7.1","MA.L2-3.7.2"],"NIST 800-53":["MA-1","MA-2","MA-4"]},reqs:["Scheduled maintenance windows and approval process are defined","Maintenance activities are logged with date, personnel, and actions taken","Remote maintenance requires multi-factor authentication","Maintenance tools and media are controlled and inspected","Maintenance personnel without access authorization are supervised"]},
  {t:"Supply Chain Risk Management Policy",type:"Policy",fw:{"NIST CSF":["ID.SC-1","ID.SC-3"],"ISO 27001":["A.15.1.3"],"CMMC":["PS.L2-3.9.1"],"NIST 800-53":["SR-1","SR-2","SR-3"]},reqs:["Supply chain risk assessment methodology is documented","Critical suppliers and components are identified and prioritized","Security requirements are included in supplier contracts","Supply chain incident response and notification procedures exist","Periodic supply chain risk reviews are conducted and documented"]},
  {t:"Personnel Security Policy",type:"Policy",fw:{"ISO 27001":["A.7.1.1","A.7.1.2","A.7.3.1"],"HIPAA":["§164.308(a)(3)(i)"],"PCI DSS":["Req 12.7"],"CMMC":["PS.L2-3.9.1","PS.L2-3.9.2"],"NIST 800-53":["PS-1","PS-3","PS-4"]},reqs:["Background screening requirements are defined for all roles","Security responsibilities are included in employment terms","Termination and transfer procedures address access revocation","Disciplinary process for security violations is documented","Security obligations that remain valid after employment are specified"]},
  {t:"Media Handling & Protection Policy",type:"Policy",fw:{"ISO 27001":["A.8.3.1","A.8.3.3"],"HIPAA":["§164.310(d)(1)"],"PCI DSS":["Req 9.4","Req 9.5"],"CMMC":["MP.L2-3.8.1","MP.L2-3.8.2"],"NIST 800-53":["MP-1","MP-2","MP-6"]},reqs:["Approved media types and handling procedures are defined","Media transport and storage security requirements are specified","Removable media usage restrictions are documented","Media sanitization procedures are defined for each media type","Media inventory and chain of custody tracking is maintained"]},
  {t:"Secure Development Lifecycle Policy",type:"Policy",fw:{"NIST CSF":["PR.IP-2"],"ISO 27001":["A.14.2.1","A.14.2.5"],"SOC 2":["CC8.1"],"PCI DSS":["Req 6.1","Req 6.2"],"CMMC":["SI.L2-3.14.1"],"NIST 800-53":["SA-3","SA-8","SA-11"]},reqs:["Secure SDLC phases and security gates are defined","Code review and static analysis requirements are specified","Security testing is required before production deployment","Separation of development, testing, and production environments is enforced","Developer security training requirements are documented"]},
  // ── PROCEDURES ────────────────────────────────────────────────────────
  {t:"Incident Response Plan",type:"Procedure",fw:{"NIST CSF":["RS.RP-1","RS.CO-1"],"ISO 27001":["A.16.1.1","A.16.1.5"],"SOC 2":["CC7.3","CC7.4"],"HIPAA":["§164.308(a)(6)(i)","§164.308(a)(6)(ii)"],"PCI DSS":["Req 12.10"],"GDPR":["Art.33","Art.34"],"CMMC":["IR.L2-3.6.1","IR.L2-3.6.2"],"NIST 800-53":["IR-1","IR-4","IR-8"]},reqs:["Incident classification and severity levels are defined","Escalation procedures and contact lists are documented","Communication plan for internal and external stakeholders exists","Post-incident review and lessons-learned process is defined","Plan has been tested via tabletop or simulation within the last 12 months","Roles and responsibilities for incident response team are assigned"]},
  {t:"Business Continuity & Disaster Recovery Plan",type:"Procedure",fw:{"NIST CSF":["RC.RP-1","PR.IP-9"],"ISO 27001":["A.17.1.1","A.17.1.2"],"SOC 2":["A1.2"],"HIPAA":["§164.308(a)(7)(i)","§164.308(a)(7)(ii)(B)"],"PCI DSS":["Req 12.10"],"CMMC":["IR.L2-3.6.1"],"NIST 800-53":["CP-1","CP-2","CP-10"]},reqs:["Recovery time objectives (RTO) and recovery point objectives (RPO) are defined","Critical business functions and dependencies are identified","Plan has been tested within the last 12 months with documented results","Alternate processing site and communication procedures are documented","Plan includes roles, responsibilities, and emergency contact information","Plan is reviewed and updated at least annually"]},
  {t:"Risk Assessment Procedure",type:"Procedure",fw:{"NIST CSF":["ID.RA-1","ID.RA-5","ID.RA-6"],"ISO 27001":["A.12.6.1"],"SOC 2":["CC3.1","CC3.2"],"HIPAA":["§164.308(a)(1)(ii)(A)"],"PCI DSS":["Req 12.3"],"GDPR":["Art.35"],"CMMC":["RA.L2-3.11.1"],"NIST 800-53":["RA-1","RA-3","RA-5"]},reqs:["Risk assessment methodology with scoring criteria is documented","Asset inventory used for scoping is current and complete","Threat identification and vulnerability analysis steps are defined","Risk scoring considers both likelihood and impact","Risk register is maintained and reviewed at least annually","Risk treatment options and residual risk acceptance process are documented"]},
  {t:"Backup & Recovery Procedure",type:"Procedure",fw:{"NIST CSF":["PR.IP-4"],"ISO 27001":["A.12.3.1"],"HIPAA":["§164.308(a)(7)(ii)(A)"],"PCI DSS":["Req 12.10"],"NIST 800-53":["CP-9","CP-10"]},reqs:["Backup frequency and scope for each system are defined","Backup media is stored securely at an offsite or separate location","Backup restoration tests are performed and documented periodically","Backup encryption requirements are specified","Backup monitoring and failure alerting procedures are in place"]},
  {t:"Data Breach Notification Procedure",type:"Procedure",fw:{"GDPR":["Art.33","Art.34"],"HIPAA":["§164.308(a)(6)(ii)"],"PCI DSS":["Req 12.10"],"SOC 2":["CC7.4"],"NIST 800-53":["IR-6","IR-8"]},reqs:["Breach assessment criteria and severity classification are defined","Notification timelines for regulators and affected individuals are specified","Notification templates and communication channels are prepared","Roles responsible for breach assessment and notification are assigned","Breach log documenting all incidents and notifications is maintained"]},
  {t:"Data Subject Rights Procedure",type:"Procedure",fw:{"GDPR":["Art.15","Art.16","Art.17","Art.18","Art.20","Art.21"],"NIST 800-53":["PT-4","PT-5"]},reqs:["Process for receiving and verifying data subject requests is documented","Response timelines for each right type are specified","Procedures for access, rectification, erasure, and portability are defined","Request tracking log with status and completion dates is maintained","Escalation process for complex or denied requests is documented"]},
  {t:"Data Protection Impact Assessment Procedure",type:"Procedure",fw:{"GDPR":["Art.35","Art.36"],"NIST 800-53":["RA-8"]},reqs:["Criteria for when a DPIA is required are defined","DPIA template with risk assessment methodology exists","Consultation process with the DPO is documented","Prior consultation triggers with supervisory authority are specified","Completed DPIAs are archived with mitigation actions tracked"]},
  {t:"Security Incident Reporting Procedure",type:"Procedure",fw:{"ISO 27001":["A.16.1.2","A.16.1.3"],"HIPAA":["§164.308(a)(6)(ii)"],"PCI DSS":["Req 12.10"],"CMMC":["IR.L2-3.6.2"],"NIST 800-53":["IR-6","IR-7"]},reqs:["Reporting channels and contact points are defined and accessible","Incident reporting form or template is available to all staff","Timelines for initial reporting are specified","Procedure covers both security events and suspected weaknesses","Whistleblower and anonymous reporting options are documented"]},
  {t:"User Access Review Procedure",type:"Procedure",fw:{"ISO 27001":["A.9.2.5","A.9.2.6"],"SOC 2":["CC6.2","CC6.3"],"PCI DSS":["Req 7.2"],"CMMC":["AC.L2-3.1.7"],"NIST 800-53":["AC-2","AC-6"]},reqs:["Access review frequency is defined for each system and role type","Reviewers and approvers for each system are assigned","Orphaned and dormant account detection process is documented","Review results and remediation actions are recorded","Privileged access is reviewed more frequently than standard access"]},
  {t:"Vulnerability Scanning & Penetration Testing Procedure",type:"Procedure",fw:{"ISO 27001":["A.12.6.1"],"PCI DSS":["Req 11.3","Req 11.4"],"CMMC":["RA.L2-3.11.2"],"NIST 800-53":["RA-5","CA-8"]},reqs:["Scanning scope, frequency, and tools are defined","Internal and external scan schedules are documented","Penetration test scope and rules of engagement are defined","Findings are risk-ranked and remediation timelines are assigned","Rescan or retest validates remediation of critical findings","Reports are retained and shared with relevant stakeholders"]},
  {t:"System Hardening Procedure",type:"Procedure",fw:{"ISO 27001":["A.12.1.1"],"PCI DSS":["Req 2.2"],"CMMC":["CM.L2-3.4.6","CM.L2-3.4.7"],"NIST 800-53":["CM-2","CM-6","CM-7"]},reqs:["Hardening checklists or benchmarks are defined for each OS and platform","Unnecessary services, ports, and protocols are disabled","Default accounts and passwords are changed or removed","Hardening compliance is verified before production deployment","Hardening standards are reviewed and updated at least annually"]},
  {t:"Evidence Collection & Chain of Custody Procedure",type:"Procedure",fw:{"ISO 27001":["A.16.1.7"],"CMMC":["AU.L2-3.3.1"],"NIST 800-53":["AU-9","IR-4"]},reqs:["Evidence collection methods and tools are specified","Chain of custody log template with required fields exists","Evidence storage and integrity protection requirements are defined","Roles authorized to collect and handle evidence are designated","Procedure aligns with legal and regulatory admissibility requirements"]},
  {t:"User Registration & De-registration Procedure",type:"Procedure",fw:{"ISO 27001":["A.9.2.1","A.9.2.2"],"SOC 2":["CC6.2"],"HIPAA":["§164.308(a)(4)(ii)(C)"],"CMMC":["AC.L2-3.1.1"],"NIST 800-53":["AC-2","IA-4"]},reqs:["Step-by-step account creation and approval workflow is documented","Unique user ID assignment process is defined","Account de-registration triggers and timelines are specified","Manager or data owner approval is required before access is granted","Account provisioning and de-provisioning logs are maintained"]},
  {t:"Termination & Transfer Procedure",type:"Procedure",fw:{"ISO 27001":["A.7.3.1","A.9.2.6"],"HIPAA":["§164.308(a)(3)(ii)(C)"],"PCI DSS":["Req 8.1"],"CMMC":["PS.L2-3.9.2"],"NIST 800-53":["PS-4","PS-5"]},reqs:["Access revocation checklist and timeline for terminations is documented","Asset return process including devices and badges is defined","Transfer procedure addresses role-based access changes","HR and IT coordination workflow is documented","Termination completion records with sign-off are maintained"]},
  {t:"Emergency Access Procedure",type:"Procedure",fw:{"HIPAA":["§164.312(a)(2)(ii)"],"ISO 27001":["A.9.4.1"],"NIST 800-53":["AC-14","AC-2"]},reqs:["Emergency access triggers and authorization criteria are defined","Break-glass account procedures and credentials are documented","All emergency access usage is logged and reviewed post-event","Emergency access is revoked immediately after the emergency ends","Post-event review and documentation process is specified"]},
  {t:"Contingency Plan Testing Procedure",type:"Procedure",fw:{"NIST CSF":["PR.IP-10"],"HIPAA":["§164.308(a)(7)(ii)(D)"],"ISO 27001":["A.17.1.3"],"NIST 800-53":["CP-4","CP-3"]},reqs:["Testing schedule and frequency are defined","Test scenarios and success criteria are documented","Test results and findings are recorded","Lessons learned are incorporated into plan updates","Roles and participants for each test exercise are assigned"]},
  // ── STANDARDS ─────────────────────────────────────────────────────────
  {t:"Encryption Standards",type:"Standard",fw:{"ISO 27001":["A.10.1.1"],"PCI DSS":["Req 3.5","Req 4.2"],"HIPAA":["§164.312(a)(2)(iv)","§164.312(e)(2)(ii)"],"CMMC":["SC.L2-3.13.11"],"NIST 800-53":["SC-12","SC-13"]},reqs:["Approved encryption algorithms and minimum key lengths are listed","Key management procedures including generation and rotation are defined","TLS/SSL minimum version requirements are specified","Exceptions process for legacy or non-compliant systems is documented","Standards are reviewed when new cryptographic advisories are issued"]},
  {t:"Secure Coding Standards",type:"Standard",fw:{"ISO 27001":["A.14.2.1","A.14.2.5"],"PCI DSS":["Req 6.2"],"CMMC":["SI.L2-3.14.1"],"NIST 800-53":["SA-8","SA-11","SI-10"]},reqs:["OWASP Top 10 or equivalent vulnerability categories are addressed","Input validation and output encoding requirements are specified","Secure dependency management and third-party library policies exist","Code review checklists with security criteria are documented","Secrets management and credential handling rules are defined"]},
  {t:"Network Segmentation Standards",type:"Standard",fw:{"PCI DSS":["Req 1.3","Req 1.4"],"ISO 27001":["A.13.1.3"],"CMMC":["SC.L2-3.13.1"],"NIST 800-53":["SC-7","SC-32"]},reqs:["Network zones and trust boundaries are defined and documented","Segmentation rules between zones are specified","Segmentation effectiveness is tested at least annually","DMZ requirements for public-facing systems are documented","Inter-zone traffic monitoring and logging requirements are specified"]},
  {t:"Logging & Monitoring Standards",type:"Standard",fw:{"NIST CSF":["DE.AE-3","DE.CM-1"],"ISO 27001":["A.12.4.1","A.12.4.4"],"SOC 2":["CC7.1"],"HIPAA":["§164.312(b)"],"PCI DSS":["Req 10.2","Req 10.3"],"CMMC":["AU.L2-3.3.1","AU.L2-3.3.2"],"NIST 800-53":["AU-2","AU-3","AU-8","AU-12"]},reqs:["Required log event types and fields are specified per system type","Log aggregation and centralized SIEM requirements are defined","Time synchronization standards (NTP) for all systems are specified","Log retention periods meet regulatory and business requirements","Alert rules and thresholds for anomalous activity are documented"]},
  {t:"Baseline Configuration Standards",type:"Standard",fw:{"NIST CSF":["PR.IP-1"],"ISO 27001":["A.12.1.1"],"PCI DSS":["Req 2.2"],"CMMC":["CM.L2-3.4.1","CM.L2-3.4.2"],"NIST 800-53":["CM-2","CM-6"]},reqs:["Approved baseline configurations exist for each OS and platform type","Minimum security settings and hardening parameters are specified","Deviation from baseline requires documented approval","Baseline compliance scanning frequency and tools are defined","Baselines are updated when new patches or versions are released"]},
  {t:"Wireless Security Standards",type:"Standard",fw:{"PCI DSS":["Req 2.3","Req 11.2"],"ISO 27001":["A.13.1.2"],"CMMC":["AC.L2-3.1.16","SC.L2-3.13.1"],"NIST 800-53":["AC-18","SC-40"]},reqs:["Approved wireless protocols and encryption standards are specified","Rogue access point detection and scanning procedures are defined","Wireless network authentication requirements are documented","Guest wireless is segmented from corporate networks","Wireless access point inventory is maintained and current"]},
  // ── PLANS ─────────────────────────────────────────────────────────────
  {t:"Security Assessment Plan",type:"Plan",fw:{"CMMC":["CA.L2-3.12.1","CA.L2-3.12.3"],"NIST CSF":["DE.DP-1","DE.DP-3"],"ISO 27001":["A.18.2.1"],"NIST 800-53":["CA-1","CA-2","CA-8"]},reqs:["Assessment scope, objectives, and methodology are documented","Assessment schedule and frequency are defined","Assessor qualifications and independence requirements are specified","Findings tracking and remediation timelines are documented","Plan is reviewed and updated at least annually"]},
  {t:"System Security Plan",type:"Plan",fw:{"CMMC":["CA.L2-3.12.4"],"NIST CSF":["ID.GV-1"],"NIST 800-53":["PL-2"]},reqs:["System boundaries and environment of operation are described","Security controls implemented for the system are documented","Interconnections with other systems are identified","Roles and responsibilities for system security are assigned","Plan is reviewed and updated at least annually or after significant changes"]},
  {t:"Contingency Plan",type:"Plan",fw:{"HIPAA":["§164.308(a)(7)(i)","§164.308(a)(7)(ii)(C)"],"NIST CSF":["PR.IP-9"],"NIST 800-53":["CP-1","CP-2"]},reqs:["Plan document exists and is current","Emergency mode operations procedures are defined","Critical system and data recovery priorities are documented","Plan has been tested within the last 12 months","Plan includes defined roles, responsibilities, and contact information"]},
  {t:"Risk Treatment Plan",type:"Plan",fw:{"ISO 27001":["A.5.1.1"],"NIST CSF":["ID.RA-6"],"SOC 2":["CC3.2"],"NIST 800-53":["RA-7","PM-4"]},reqs:["Risk treatment options for each identified risk are documented","Responsible owners are assigned for each risk treatment action","Implementation timelines and milestones are specified","Residual risk levels are documented and accepted by management","Plan is reviewed and updated after each risk assessment cycle"]},
  // ── GUIDELINES ────────────────────────────────────────────────────────
  {t:"Data Handling Guidelines",type:"Guideline",fw:{"GDPR":["Art.5","Art.25"],"HIPAA":["§164.312(c)(1)"],"PCI DSS":["Req 3.1","Req 3.3"],"NIST 800-53":["MP-2","MP-4","SI-12"]},reqs:["Guidelines document exists and is accessible to relevant staff","Practical examples for handling each data classification level are included","Data masking and redaction requirements are specified","Secure file transfer and sharing methods are documented","Guidelines cover both physical and electronic data handling"]},
  {t:"Secure Disposal Guidelines",type:"Guideline",fw:{"ISO 27001":["A.11.2.7"],"HIPAA":["§164.310(d)(2)(i)"],"PCI DSS":["Req 9.4"],"CMMC":["MP.L2-3.8.3"],"NIST 800-53":["MP-6"]},reqs:["Approved disposal methods are listed for each media and equipment type","Guidelines document is accessible to relevant staff","Certificates of destruction or sanitization are required","Third-party disposal vendor requirements are specified","Examples of compliant vs non-compliant disposal are provided"]},
  {t:"Visitor Management Guidelines",type:"Guideline",fw:{"ISO 27001":["A.11.1.2"],"PCI DSS":["Req 9.3"],"CMMC":["PE.L2-3.10.3","PE.L2-3.10.4"],"NIST 800-53":["PE-8","PE-2","PE-3"]},reqs:["Visitor sign-in and sign-out process is documented","Visitor badge or identification requirements are specified","Escort requirements for visitors in secure areas are defined","Visitor access logs are maintained and retained","Guidelines are posted or accessible at reception and entry points"]},
  // ── NETWORK & ARCHITECTURE DIAGRAMS ─────────────────────────────────
  {t:"Network Architecture Diagram",type:"Diagram",fw:{"PCI DSS":["Req 1.2"],"ISO 27001":["A.13.1.1"],"NIST CSF":["ID.AM-3"],"CMMC":["SC.L2-3.13.1"],"NIST 800-53":["PL-2","SC-7"]},reqs:["Diagram is current and dated within the last 12 months","All network connections and data flows are shown","CDE and sensitive network segments are clearly labeled","Diagram is reviewed and updated at least annually","Diagram includes all ingress and egress points"]},
  {t:"Data Flow Diagram",type:"Diagram",fw:{"PCI DSS":["Req 1.2"],"GDPR":["Art.30"],"HIPAA":["§164.308(a)(1)(ii)(A)"],"NIST CSF":["ID.AM-3"],"CMMC":["SC.L2-3.13.1"],"NIST 800-53":["CM-13","PL-2"]},reqs:["Data types and classifications are labeled on each flow","Transmission methods and protocols are shown","Encryption points are clearly marked on the diagram","Storage locations for each data type are identified","Diagram is updated when systems or data flows change"]},
  {t:"Cloud Architecture Diagram",type:"Diagram",fw:{"ISO 27001":["A.13.1.1"],"SOC 2":["CC6.1"],"NIST CSF":["PR.AC-5"],"NIST 800-53":["PL-8","SC-7"]},reqs:["Cloud provider boundaries and regions are clearly depicted","Shared responsibility model is documented alongside the diagram","Security controls placement is shown at each layer","Inter-cloud and on-premises connections are documented","Diagram is reviewed when cloud infrastructure changes"]},
  {t:"System Boundary & Scope Document",type:"Diagram",fw:{"PCI DSS":["Req 12.5"],"CMMC":["CA.L2-3.12.4"],"SOC 2":["CC6.1"],"NIST 800-53":["PL-2","CA-9"]},reqs:["All in-scope systems and components are listed","Boundary justification and exclusion rationale are documented","Document is reviewed and approved at least annually","Connected third-party systems are identified","Scope changes trigger a re-evaluation and update"]},
  // ── ASSET INVENTORIES ───────────────────────────────────────────────
  {t:"Hardware Asset Inventory",type:"Inventory",fw:{"NIST CSF":["ID.AM-1"],"ISO 27001":["A.8.1.1"],"PCI DSS":["Req 2.1"],"CMMC":["CM.L2-3.4.1"],"NIST 800-53":["CM-8","PM-5"]},reqs:["All hardware assets listed with owner and physical location","Serial numbers and asset tags are recorded for each item","Inventory is updated when assets are added, moved, or decommissioned","Asset classification and criticality ratings are assigned","Inventory is reconciled at least quarterly"]},
  {t:"Software Asset Inventory",type:"Inventory",fw:{"NIST CSF":["ID.AM-2"],"ISO 27001":["A.8.1.1"],"PCI DSS":["Req 2.1"],"CMMC":["CM.L2-3.4.1"],"NIST 800-53":["CM-8","CM-10","PM-5"]},reqs:["All software listed with version numbers and vendor details","License status and entitlements are tracked for each application","Unauthorized or unapproved software is identified and flagged","Inventory is updated when software is installed or removed","Software end-of-life and support status is tracked"]},
  {t:"Data Asset Inventory & Data Map",type:"Inventory",fw:{"GDPR":["Art.30"],"HIPAA":["§164.308(a)(1)(ii)(A)"],"ISO 27001":["A.8.1.1"],"NIST CSF":["ID.AM-5"],"NIST 800-53":["CM-12","CM-13","RA-2"]},reqs:["All data types are catalogued with classification levels","Storage locations and repositories are documented for each data type","Data owners are assigned and documented","Data flows between systems and external parties are mapped","Inventory is reviewed and updated at least annually"]},
  {t:"Encryption Key Inventory",type:"Inventory",fw:{"PCI DSS":["Req 3.6"],"ISO 27001":["A.10.1.2"],"CMMC":["SC.L2-3.13.11"],"NIST 800-53":["SC-12"]},reqs:["All cryptographic keys listed with purpose and algorithm","Expiration and rotation dates are tracked for each key","Key custodians are assigned and documented","Rotation schedule is defined and followed","Key inventory is reviewed at least quarterly"]},
  {t:"Authorized User List",type:"Inventory",fw:{"CMMC":["AC.L2-3.1.1"],"HIPAA":["§164.312(a)(1)"],"PCI DSS":["Req 8.1"],"NIST 800-53":["AC-2","IA-4"]},reqs:["All authorized users listed with role and access level","List is reviewed and approved at least quarterly","Terminated users are removed within 24 hours","Access level changes are reflected promptly in the list","List includes both internal users and external/vendor accounts"]},
  ...
  {t:"Vendor Security Assessments",type:"Agreement",fw:{"ISO 27001":["A.15.2.1"],"SOC 2":["CC9.2"],"NIST CSF":["ID.SC-4"],"PCI DSS":["Req 12.8"],"NIST 800-53":["SR-6","SA-9"]},reqs:["Annual risk assessment is conducted for all critical vendors","Security questionnaires or assessments are completed and on file","Identified risks are tracked with remediation actions","Vendor risk ratings are assigned and reviewed periodically","Assessment results are reported to management"]},
  ...
  {t:"Annual Risk Assessment Report",type:"Report",fw:{"NIST CSF":["ID.RA-5"],"ISO 27001":["A.12.6.1"],"SOC 2":["CC3.2"],"HIPAA":["§164.308(a)(1)(ii)(A)"],"PCI DSS":["Req 12.3"],"CMMC":["RA.L2-3.11.1"],"NIST 800-53":["RA-3","RA-5"]},reqs:["Assessment conducted within the last 12 months","All in-scope assets and systems are covered","Threats and vulnerabilities are identified and documented","Risk scores are calculated using defined methodology","Remediation recommendations are prioritized by risk level"]},
  {t:"Internal Vulnerability Scan Reports",type:"Report",fw:{"PCI DSS":["Req 11.3"],"ISO 27001":["A.12.6.1"],"CMMC":["RA.L2-3.11.2"],"NIST CSF":["DE.CM-8"],"NIST 800-53":["RA-5"]},reqs:["Internal scans conducted at least quarterly","Critical and high findings are remediated and rescanned","Scan tool, scope, and methodology are documented","Trend analysis of findings over time is maintained","Scan reports are retained for audit review"]},
  {t:"External Vulnerability Scan Reports (ASV)",type:"Report",fw:{"PCI DSS":["Req 11.3"]},reqs:["Quarterly ASV scans performed by PCI-approved vendor","Passing scan results are on file for each quarter","Failed scans are remediated and rescanned until passing","ASV attestation of scan compliance is current","Scan scope covers all external-facing IP addresses"]},
  {t:"Penetration Test Report",type:"Report",fw:{"PCI DSS":["Req 11.4"],"ISO 27001":["A.12.6.1"],"CMMC":["CA.L2-3.12.1"],"NIST 800-53":["CA-8"]},reqs:["Annual penetration test conducted by qualified tester","Both internal and external testing scopes are covered","Findings include severity ratings and exploitation evidence","Remediation evidence is documented for critical findings","Retest validates remediation of exploitable vulnerabilities"]},
  {t:"Business Impact Analysis (BIA)",type:"Report",fw:{"ISO 27001":["A.17.1.1"],"HIPAA":["§164.308(a)(7)(ii)(E)"],"NIST CSF":["ID.BE-4"],"NIST 800-53":["RA-9","CP-2"]},reqs:["Critical business functions are identified and prioritized","RTO and RPO are defined for each critical function","Dependencies between systems and processes are documented","Financial and operational impact estimates are included","BIA is reviewed and updated at least annually"]},
  {t:"Gap Analysis / Maturity Assessment Report",type:"Report",fw:{"ISO 27001":["A.18.2.1"],"NIST CSF":["ID.GV-4"],"CMMC":["CA.L2-3.12.1"],"NIST 800-53":["CA-2","PM-6"]},reqs:["Current state assessed against target framework requirements","Gaps identified with severity and priority ratings","Remediation roadmap with timelines is created","Responsible owners are assigned for each gap item","Assessment is refreshed at least annually"]},
  {t:"Internal Audit Report",type:"Report",fw:{"ISO 27001":["A.18.2.1"],"SOC 2":["CC4.1"],"CMMC":["CA.L2-3.12.3"],"NIST 800-53":["CA-2","CA-7"]},reqs:["Annual internal audit conducted by qualified personnel","Audit scope covers all relevant security domains","Findings are documented with severity and evidence","Corrective actions are tracked to closure","Audit report is reviewed by senior management"]},
  {t:"Third-Party / SOC Audit Reports from Vendors",type:"Report",fw:{"SOC 2":["CC9.2"],"ISO 27001":["A.15.2.1"],"PCI DSS":["Req 12.8"],"NIST 800-53":["SR-6","SA-9"]},reqs:["SOC 2 or equivalent reports collected from critical vendors annually","Reports reviewed for exceptions and qualified opinions","Complementary user entity controls are assessed","Gaps in vendor controls are tracked with mitigations","Report collection and review records are maintained"]},
  {t:"Wireless Network Assessment Report",type:"Report",fw:{"PCI DSS":["Req 11.2"],"ISO 27001":["A.13.1.2"],"CMMC":["AC.L2-3.1.16"]},reqs:["Quarterly wireless scans are conducted","Rogue access points are identified and remediated","Authorized wireless access point inventory is maintained","Scan methodology and tools are documented","Assessment results are reviewed by network security team"]},
  // ── TRAINING RECORDS ────────────────────────────────────────────────
  {t:"Security Awareness Training Records",type:"Record",fw:{"NIST CSF":["PR.AT-1"],"ISO 27001":["A.7.2.2"],"SOC 2":["CC1.4"],"HIPAA":["§164.308(a)(5)(i)"],"PCI DSS":["Req 12.6"],"CMMC":["AT.L2-3.2.1"],"NIST 800-53":["AT-2","AT-4"]},reqs:["All employees completed training within the last 12 months","Completion rates are tracked and reported to management","Training includes phishing and social engineering awareness","New hires complete training within 30 days of start date","Training content is updated at least annually"]},
  {t:"Role-Based Security Training Records",type:"Record",fw:{"NIST CSF":["PR.AT-2"],"ISO 27001":["A.7.2.2"],"PCI DSS":["Req 12.6"],"CMMC":["AT.L2-3.2.2"],"NIST 800-53":["AT-3","AT-4"]},reqs:["Developers receive secure coding training annually","Admins receive privileged access and system security training","Training content is specific to each job function","Completion records are maintained with dates and scores","Training is updated when roles or technologies change"]},
  {t:"Phishing Simulation Results",type:"Record",fw:{"NIST CSF":["PR.AT-1"],"SOC 2":["CC1.4"],"CMMC":["AT.L2-3.2.3"],"NIST 800-53":["AT-2"]},reqs:["Phishing simulations conducted at least quarterly","Click and report rates are tracked over time","Repeat offenders receive additional targeted training","Simulation scenarios are varied and realistic","Results are reported to management with trend analysis"]},
  {t:"New Hire Security Acknowledgment Records",type:"Record",fw:{"ISO 27001":["A.7.1.2"],"HIPAA":["§164.308(a)(5)(i)"],"PCI DSS":["Req 12.6"]},reqs:["Signed acknowledgment of security policies on file for each hire","Acknowledgment completed within first week of employment","Covers acceptable use, data handling, and incident reporting","Records are securely stored and retrievable for audit","Acknowledgment is renewed annually or upon policy changes"]},
  // ── OPERATIONAL RECORDS ─────────────────────────────────────────────
  {t:"Access Review Records",type:"Record",fw:{"ISO 27001":["A.9.2.5"],"SOC 2":["CC6.2"],"PCI DSS":["Req 7.2"],"HIPAA":["§164.308(a)(4)(ii)(C)"],"CMMC":["AC.L2-3.1.7"],"NIST 800-53":["AC-2","AC-6"]},reqs:["Access reviews conducted at least quarterly","All user accounts and privileges are reviewed per system","Excessive or inappropriate privileges are revoked promptly","Review sign-off by system owner or manager is documented","Remediation actions and exceptions are tracked"]},
  {t:"Change Management Records",type:"Record",fw:{"ISO 27001":["A.12.1.2"],"SOC 2":["CC8.1"],"PCI DSS":["Req 6.5"],"NIST 800-53":["CM-3","CM-4"]},reqs:["All changes logged with requestor, approver, and date","Impact assessment is documented for each change","Rollback plan is included in the change record","Post-implementation review is conducted and recorded","Emergency changes are documented with retroactive approval"]},
  {t:"Patch Management Records",type:"Record",fw:{"ISO 27001":["A.12.6.1"],"PCI DSS":["Req 6.3"],"CMMC":["SI.L2-3.14.1"],"NIST CSF":["PR.IP-12"],"NIST 800-53":["SI-2"]},reqs:["Critical patches applied within 30 days of release","Patch compliance rate is tracked across all systems","Exceptions are documented with compensating controls","Patch testing is performed before production deployment","Patch deployment records include date, systems, and results"]},
  {t:"Backup Verification & Restoration Test Records",type:"Record",fw:{"ISO 27001":["A.12.3.1"],"HIPAA":["§164.308(a)(7)(ii)(A)"],"PCI DSS":["Req 12.10"],"NIST CSF":["PR.IP-4"],"NIST 800-53":["CP-9","CP-4"]},reqs:["Backup restoration tests performed at least quarterly","Successful restoration is documented with date and scope","Recovery time is measured and compared against RTO","Offsite or secondary storage is verified as accessible","Failed restoration tests trigger immediate remediation"]},
  {t:"DR/BCP Test Results",type:"Record",fw:{"ISO 27001":["A.17.1.3"],"HIPAA":["§164.308(a)(7)(ii)(D)"],"SOC 2":["A1.3"],"NIST CSF":["PR.IP-10"],"NIST 800-53":["CP-4"]},reqs:["DR/BCP test conducted at least annually","Test scenario, scope, and participants are documented","Results measured against success criteria and RTO/RPO","Lessons learned are recorded and plan is updated","Test report is reviewed and approved by management"]},
  {t:"Terminated User Access Removal Evidence",type:"Record",fw:{"ISO 27001":["A.7.3.1"],"HIPAA":["§164.308(a)(3)(ii)(C)"],"PCI DSS":["Req 8.1"],"CMMC":["PS.L2-3.9.2"],"NIST 800-53":["PS-4","AC-2"]},reqs:["Access removed within 24 hours of termination date","All systems, applications, and physical access are revoked","Removal is verified and documented with timestamps","Shared or service account password changes are triggered","Removal records are retained for audit review"]},
  {t:"Security Metrics & KPI Reports",type:"Record",fw:{"ISO 27001":["A.18.2.2"],"SOC 2":["CC4.1"],"NIST CSF":["DE.DP-5"],"NIST 800-53":["PM-6","PM-14"]},reqs:["Metrics collected and reported at least quarterly","Key areas covered include incidents, vulnerabilities, and compliance","Trends are tracked over time with visual dashboards","Reports are distributed to senior management","Targets and thresholds are defined for each KPI"]},
  // ── LOGS & MONITORING EVIDENCE ──────────────────────────────────────
  {t:"Audit Log Samples",type:"Evidence",fw:{"PCI DSS":["Req 10.2"],"ISO 27001":["A.12.4.1"],"HIPAA":["§164.312(b)"],"CMMC":["AU.L2-3.3.1"],"NIST 800-53":["AU-2","AU-3","AU-9"]},reqs:["Logs capture user activity, access events, and system changes","Log entries include timestamp, user ID, action, and result","Logs retained for minimum of 1 year (3 months immediately available)","Log integrity protection mechanisms are in place","Sample logs are available for the full audit period"]},
  {t:"SIEM / Security Monitoring Evidence",type:"Evidence",fw:{"PCI DSS":["Req 10.4"],"ISO 27001":["A.12.4.1"],"SOC 2":["CC7.2"],"NIST CSF":["DE.AE-3"],"NIST 800-53":["SI-4","AU-6"]},reqs:["Centralized log management or SIEM solution is deployed","Alerting rules are configured for key security events","Alerts are reviewed and triaged within defined timeframes","24/7 monitoring or after-hours coverage is documented","SIEM dashboards and correlation rules are maintained"]},
  {t:"Firewall Rule Review Evidence",type:"Evidence",fw:{"PCI DSS":["Req 1.2"],"ISO 27001":["A.13.1.1"],"CMMC":["SC.L2-3.13.1"],"NIST 800-53":["SC-7","AC-4"]},reqs:["Firewall rules reviewed at least every 6 months","Unused, expired, or overly permissive rules are removed","Default deny-all rule is in place on all firewalls","Review sign-off by network security owner is documented","Rule change history is maintained and auditable"]},
  {t:"Access Log Samples",type:"Evidence",fw:{"HIPAA":["§164.312(b)"],"PCI DSS":["Req 10.2"],"ISO 27001":["A.12.4.1"],"CMMC":["AU.L2-3.3.1"],"NIST 800-53":["AU-2","AU-3"]},reqs:["Successful and failed login attempts are captured","Privileged access activity is logged separately","Log samples are available for the complete audit period","Logs include source IP, timestamp, and user identity","Anomalous access patterns are flagged for review"]},
  // ── TECHNICAL CONFIGURATION EVIDENCE ────────────────────────────────
  {t:"System Hardening Evidence (CIS Benchmarks)",type:"Evidence",fw:{"PCI DSS":["Req 2.2"],"ISO 27001":["A.12.1.1"],"CMMC":["CM.L2-3.4.6"],"NIST 800-53":["CM-6","CM-7"]},reqs:["Hardening standards applied to all in-scope systems","CIS Benchmark or equivalent standard is used as baseline","Compliance scan results are available for audit review","Deviations are documented and approved by management","Hardening evidence is refreshed at least quarterly"]},
  {t:"MFA Configuration Evidence",type:"Evidence",fw:{"PCI DSS":["Req 8.4"],"NIST CSF":["PR.AC-7"],"CMMC":["IA.L2-3.5.3"],"ISO 27001":["A.9.4.2"],"NIST 800-53":["IA-2"]},reqs:["MFA enabled for all remote access connections","MFA required for all admin and privileged accounts","MFA technology and supported methods are documented","Configuration screenshots or exports are available","MFA bypass or exception processes are documented"]},
  {t:"Encryption-at-Rest Configuration Evidence",type:"Evidence",fw:{"PCI DSS":["Req 3.5"],"HIPAA":["§164.312(a)(2)(iv)"],"ISO 27001":["A.10.1.1"],"CMMC":["SC.L2-3.13.11"],"NIST 800-53":["SC-28","SC-12"]},reqs:["Encryption enabled for all sensitive data stores","AES-256 or equivalent algorithm is used","Key management procedures are followed and documented","Configuration screenshots or audit exports are available","Unencrypted sensitive data stores are documented as exceptions"]},
  {t:"Encryption-in-Transit Configuration Evidence",type:"Evidence",fw:{"PCI DSS":["Req 4.2"],"HIPAA":["§164.312(e)(2)(ii)"],"ISO 27001":["A.10.1.1"],"CMMC":["SC.L2-3.13.8"],"NIST 800-53":["SC-8","SC-12"]},reqs:["TLS 1.2 or higher enforced on all connections","SSL/TLS certificate inventory is maintained","Weak ciphers and protocols are disabled","Configuration evidence from servers and load balancers is available","Certificate expiration monitoring is in place"]},
  {t:"Endpoint Protection Configuration Evidence",type:"Evidence",fw:{"ISO 27001":["A.12.2.1"],"PCI DSS":["Req 5.2"],"CMMC":["SI.L2-3.14.2"],"NIST 800-53":["SI-3"]},reqs:["Antivirus or EDR deployed on all endpoints","Real-time scanning is enabled and active","Signature and definition updates are automated","Central management console screenshots are available","Unprotected endpoints are documented as exceptions with mitigations"]},
  {t:"Account Lockout & Password Configuration",type:"Evidence",fw:{"PCI DSS":["Req 8.3"],"HIPAA":["§164.308(a)(5)(ii)(D)"],"ISO 27001":["A.9.4.3"],"CMMC":["IA.L2-3.5.7"],"NIST 800-53":["AC-7","IA-5"]},reqs:["Account lockout after defined number of failed attempts","Minimum password complexity requirements are enforced","Password expiration or rotation policy is configured","Configuration screenshots from directory services are available","Password history prevents reuse of recent passwords"]},
  ...
  // ── REGISTERS & LOGS ────────────────────────────────────────────────
  {t:"Incident Register / Security Incident Log",type:"Register",fw:{"ISO 27001":["A.16.1.5"],"SOC 2":["CC7.3"],"HIPAA":["§164.308(a)(6)(i)"],"PCI DSS":["Req 12.10"],"NIST CSF":["RS.AN-4"],"CMMC":["IR.L2-3.6.2"],"NIST 800-53":["IR-5","IR-6"]},reqs:["All security incidents logged with date, description, and severity","Response actions and timelines are documented per incident","Root cause analysis is performed for significant incidents","Lessons learned are recorded and fed back into controls","Incident register is reviewed by management at least quarterly"]},
  ...
  {t:"Plan of Action & Milestones (POA&M)",type:"Register",fw:{"CMMC":["CA.L2-3.12.2"],"NIST CSF":["ID.RA-6"],"NIST 800-53":["CA-5","PM-4"]},reqs:["All open findings tracked with responsible party assigned","Planned completion dates are set for each item","Milestones defined for long-term remediation items","POA&M is reviewed and updated at least monthly","Status and progress are reported to management"]},
