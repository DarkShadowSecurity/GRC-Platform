...
const GOV_ITEMS = [
  // ── POLICIES ──────────────────────────────────────────────────────────
  {t:"Information Security Policy",type:"Policy",fw:{"NIST CSF":["ID.GV-1"],"ISO 27001":["A.5.1.1","A.5.1.2"],"SOC 2":["CC1.1"],"HIPAA":["§164.308(a)(1)(i)"],"PCI DSS":["Req 12.1"],"GDPR":["Art.24"],"CMMC":["CA.L2-3.12.1"]},reqs:["Management-approved information security policy document exists","Policy defines scope, objectives, and principles of information security","Roles and responsibilities for information security are defined","Policy is communicated to all employees and relevant external parties","Policy is reviewed at least annually or after significant changes"]},
  {t:"Access Control Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-1","PR.AC-4"],"ISO 27001":["A.9.1.1","A.9.1.2"],"SOC 2":["CC6.1","CC6.2"],"HIPAA":["§164.312(a)(1)"],"PCI DSS":["Req 7.1","Req 8.1"],"GDPR":["Art.32"],"CMMC":["AC.L2-3.1.1","AC.L2-3.1.2"]},reqs:["Least privilege principle is documented and enforced","Access provisioning and de-provisioning processes are defined","Periodic access reviews are conducted and documented","Privileged account management procedures are specified","Separation of duties requirements are documented"]},
  {t:"Data Classification Policy",type:"Policy",fw:{"ISO 27001":["A.8.2.1","A.8.2.2"],"SOC 2":["CC6.1"],"PCI DSS":["Req 3.1"],"GDPR":["Art.9"],"CMMC":["MP.L2-3.8.1"]},reqs:["Data classification levels are defined with clear criteria","Labeling and handling requirements exist for each classification level","Data owners are assigned and documented for all data assets","Classification review process is defined and performed periodically","Procedures for reclassification and declassification are documented"]},
  {t:"Acceptable Use Policy",type:"Policy",fw:{"ISO 27001":["A.8.1.3"],"SOC 2":["CC1.1"],"PCI DSS":["Req 12.2"],"CMMC":["AT.L2-3.2.1"]},reqs:["Permitted and prohibited uses of organizational assets are defined","Employee acknowledgment records are maintained","Policy covers internet, email, social media, and personal device usage","Consequences for policy violations are specified","Policy is reviewed and updated at least annually"]},
  {t:"Privacy Policy & Notice",type:"Policy",fw:{"GDPR":["Art.12","Art.13","Art.14"],"HIPAA":["§164.312(c)(1)"],"SOC 2":["P1.1","P1.2"]},reqs:["Privacy notice is publicly accessible and written in clear language","Legal basis for each data processing activity is documented","Data subject rights and how to exercise them are described","Data retention periods are specified for each data category","Contact details of the data protection officer or privacy team are provided"]},
  {t:"Encryption & Cryptography Policy",type:"Policy",fw:{"ISO 27001":["A.10.1.1","A.10.1.2"],"PCI DSS":["Req 3.5","Req 4.1"],"HIPAA":["§164.312(a)(2)(iv)","§164.312(e)(2)(ii)"],"GDPR":["Art.32"],"CMMC":["SC.L2-3.13.11"]},reqs:["Approved cryptographic algorithms and minimum key lengths are specified","Key management lifecycle procedures are documented","Encryption requirements for data at rest and in transit are defined","Crypto key custodian roles and responsibilities are assigned","Policy mandates use of FIPS-validated or equivalent cryptographic modules"]},
  {t:"Physical Security Policy",type:"Policy",fw:{"ISO 27001":["A.11.1.1","A.11.1.2"],"HIPAA":["§164.310(a)(1)","§164.310(a)(2)(ii)"],"PCI DSS":["Req 9.1"],"CMMC":["PE.L2-3.10.1","PE.L2-3.10.2"]},reqs:["Physical security perimeters and secure areas are defined","Physical access control mechanisms are documented","Visitor management procedures are specified","Physical access logs are maintained and reviewed","Environmental controls for server rooms and data centers are documented"]},
  {t:"Network Security Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-5","PR.PT-4"],"ISO 27001":["A.13.1.1","A.13.1.3"],"PCI DSS":["Req 1.1","Req 1.2"],"CMMC":["SC.L2-3.13.1","SC.L2-3.13.6"]},reqs:["Network architecture diagram exists and is current","Firewall and router rule sets are documented and reviewed","Network segmentation requirements are defined","Default-deny rules are implemented at network boundaries","Network security controls are tested at least annually"]},
  {t:"Remote Access Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-3"],"ISO 27001":["A.6.2.2"],"PCI DSS":["Req 8.4"],"CMMC":["AC.L2-3.1.12","AC.L2-3.1.14"]},reqs:["Approved remote access methods and technologies are specified","Multi-factor authentication is required for all remote access","VPN or encrypted tunnel requirements are documented","Remote session timeout and monitoring requirements are defined","Remote access authorization and revocation process is documented"]},
  {t:"Password & Authentication Policy",type:"Policy",fw:{"NIST CSF":["PR.AC-1","PR.AC-7"],"ISO 27001":["A.9.3.1","A.9.4.3"],"HIPAA":["§164.308(a)(5)(ii)(D)"],"PCI DSS":["Req 8.2","Req 8.3"],"CMMC":["IA.L2-3.5.7","IA.L2-3.5.8"]},reqs:["Minimum password complexity and length requirements are specified","Account lockout thresholds and duration are defined","Multi-factor authentication requirements are documented","Password history and expiration rules are specified","Service account and shared credential management procedures exist"]},
  {t:"Change Management Policy",type:"Policy",fw:{"ISO 27001":["A.12.1.2","A.14.2.2"],"SOC 2":["CC8.1"],"PCI DSS":["Req 6.5"],"CMMC":["CM.L2-3.4.3","CM.L2-3.4.4"]},reqs:["Change request, approval, and documentation process is defined","Impact analysis is required before changes are implemented","Rollback procedures are documented for all changes","Emergency change process is defined with post-implementation review","Change log is maintained with approver, date, and description"]},
  {t:"Vendor & Third-Party Management Policy",type:"Policy",fw:{"NIST CSF":["ID.SC-1","ID.SC-2"],"ISO 27001":["A.15.1.1","A.15.1.2"],"SOC 2":["CC9.1","CC9.2"],"GDPR":["Art.28"],"PCI DSS":["Req 12.8"]},reqs:["Vendor risk assessment process is documented","Security requirements are included in vendor contracts","Periodic vendor security reviews are conducted and documented","Vendor inventory with risk ratings is maintained","Data processing agreements exist for all vendors handling sensitive data"]},
  {t:"Data Retention & Disposal Policy",type:"Policy",fw:{"ISO 27001":["A.8.3.1","A.8.3.2"],"HIPAA":["§164.310(d)(2)(i)","§164.310(d)(2)(ii)"],"PCI DSS":["Req 3.1","Req 9.4"],"GDPR":["Art.5","Art.17"],"CMMC":["MP.L2-3.8.3"]},reqs:["Retention periods are defined for each data type and legal basis","Approved data destruction methods are specified for each media type","Disposal certificates or proof of destruction are maintained","Automated retention enforcement mechanisms are documented","Exceptions process for extended retention is defined"]},
  {t:"Mobile Device & BYOD Policy",type:"Policy",fw:{"ISO 27001":["A.6.2.1"],"CMMC":["AC.L2-3.1.18","AC.L2-3.1.19"]},reqs:["Approved mobile device types and operating systems are specified","Mobile device management (MDM) enrollment is required","Encryption requirements for mobile devices are defined","Remote wipe capability is documented and tested","BYOD acceptable use and data separation requirements are specified"]},
  {t:"Security Awareness & Training Policy",type:"Policy",fw:{"NIST CSF":["PR.AT-1","PR.AT-2"],"ISO 27001":["A.7.2.2"],"SOC 2":["CC1.4"],"HIPAA":["§164.308(a)(5)(i)"],"PCI DSS":["Req 12.6"],"CMMC":["AT.L2-3.2.1","AT.L2-3.2.2"]},reqs:["Annual security awareness training is mandatory for all employees","Training completion records are tracked and maintained","Role-based training is provided for privileged and technical staff","Phishing simulation exercises are conducted periodically","New hire security training is completed within 30 days of start date"]},
  {t:"Vulnerability Management Policy",type:"Policy",fw:{"NIST CSF":["PR.IP-12"],"ISO 27001":["A.12.6.1"],"PCI DSS":["Req 6.3","Req 11.3"],"CMMC":["SI.L2-3.14.1"]},reqs:["Vulnerability scanning frequency and scope are defined","Risk-based remediation timelines are specified by severity level","Patch management process and SLAs are documented","Exception and risk acceptance process for unpatched vulnerabilities exists","Vulnerability scan results and remediation tracking are maintained"]},
  {t:"Audit Logging & Monitoring Policy",type:"Policy",fw:{"NIST CSF":["DE.CM-1","PR.PT-1"],"ISO 27001":["A.12.4.1","A.12.4.3"],"SOC 2":["CC7.1","CC7.2"],"HIPAA":["§164.312(b)"],"PCI DSS":["Req 10.1","Req 10.2"],"CMMC":["AU.L2-3.3.1","AU.L2-3.3.2"]},reqs:["Auditable events and log contents are defined","Log retention periods and storage requirements are specified","Log integrity protection and tamper-detection mechanisms are defined","Log review frequency and responsible roles are assigned","Alerting thresholds and escalation procedures are documented"]},
  {t:"Configuration Management Policy",type:"Policy",fw:{"NIST CSF":["PR.IP-1"],"ISO 27001":["A.12.1.1"],"PCI DSS":["Req 2.1","Req 2.2"],"CMMC":["CM.L2-3.4.1","CM.L2-3.4.2"]},reqs:["Baseline configurations are established for all system types","Default credentials and unnecessary services must be removed or disabled","Configuration drift detection and remediation process is defined","Approved software and hardware inventories are maintained","Configuration change approval workflow is documented"]},
  {t:"System Maintenance Policy",type:"Policy",fw:{"NIST CSF":["PR.MA-1","PR.MA-2"],"ISO 27001":["A.11.2.4"],"CMMC":["MA.L2-3.7.1","MA.L2-3.7.2"]},reqs:["Scheduled maintenance windows and approval process are defined","Maintenance activities are logged with date, personnel, and actions taken","Remote maintenance requires multi-factor authentication","Maintenance tools and media are controlled and inspected","Maintenance personnel without access authorization are supervised"]},
  ...
  {t:"Vendor Security Assessments",type:"Agreement",fw:{"ISO 27001":["A.15.2.1"],"SOC 2":["CC9.2"],"NIST CSF":["ID.SC-4"],"PCI DSS":["Req 12.8"]},reqs:["Annual risk assessment is conducted for all critical vendors","Security questionnaires or assessments are completed and on file","Identified risks are tracked with remediation actions","Vendor risk ratings are assigned and reviewed periodically","Assessment results are reported to management"]},
  ...
  // ── TRAINING RECORDS ────────────────────────────────────────────────
  {t:"Security Awareness Training Records",type:"Record",fw:{"NIST CSF":["PR.AT-1"],"ISO 27001":["A.7.2.2"],"SOC 2":["CC1.4"],"HIPAA":["§164.308(a)(5)(i)"],"PCI DSS":["Req 12.6"],"CMMC":["AT.L2-3.2.1"]},reqs:["All employees completed training within the last 12 months","Completion rates are tracked and reported to management","Training includes phishing and social engineering awareness","New hires complete training within 30 days of start date","Training content is updated at least annually"]},
  {t:"Role-Based Security Training Records",type:"Record",fw:{"NIST CSF":["PR.AT-2"],"ISO 27001":["A.7.2.2"],"PCI DSS":["Req 12.6"],"CMMC":["AT.L2-3.2.2"]},reqs:["Developers receive secure coding training annually","Admins receive privileged access and system security training","Training content is specific to each job function","Completion records are maintained with dates and scores","Training is updated when roles or technologies change"]},
  {t:"Phishing Simulation Results",type:"Record",fw:{"NIST CSF":["PR.AT-1"],"SOC 2":["CC1.4"],"CMMC":["AT.L2-3.2.3"]},reqs:["Phishing simulations conducted at least quarterly","Click and report rates are tracked over time","Repeat offenders receive additional targeted training","Simulation scenarios are varied and realistic","Results are reported to management with trend analysis"]},
  ...
  // ── OPERATIONAL RECORDS ─────────────────────────────────────────────
  {t:"Access Review Records",type:"Record",fw:{"ISO 27001":["A.9.2.5"],"SOC 2":["CC6.2"],"PCI DSS":["Req 7.2"],"HIPAA":["§164.308(a)(4)(ii)(C)"],"CMMC":["AC.L2-3.1.7"]},reqs:["Access reviews conducted at least quarterly","All user accounts and privileges are reviewed per system","Excessive or inappropriate privileges are revoked promptly","Review sign-off by system owner or manager is documented","Remediation actions and exceptions are tracked"]},
  {t:"Change Management Records",type:"Record",fw:{"ISO 27001":["A.12.1.2"],"SOC 2":["CC8.1"],"PCI DSS":["Req 6.5"]},reqs:["All changes logged with requestor, approver, and date","Impact assessment is documented for each change","Rollback plan is included in the change record","Post-implementation review is conducted and recorded","Emergency changes are documented with retroactive approval"]},
  {t:"Patch Management Records",type:"Record",fw:{"ISO 27001":["A.12.6.1"],"PCI DSS":["Req 6.3"],"CMMC":["SI.L2-3.14.1"],"NIST CSF":["PR.IP-12"]},reqs:["Critical patches applied within 30 days of release","Patch compliance rate is tracked across all systems","Exceptions are documented with compensating controls","Patch testing is performed before production deployment","Patch deployment records include date, systems, and results"]},
  {t:"Backup Verification & Restoration Test Records",type:"Record",fw:{"ISO 27001":["A.12.3.1"],"HIPAA":["§164.308(a)(7)(ii)(A)"],"PCI DSS":["Req 12.10"],"NIST CSF":["PR.IP-4"]},reqs:["Backup restoration tests performed at least quarterly","Successful restoration is documented with date and scope","Recovery time is measured and compared against RTO","Offsite or secondary storage is verified as accessible","Failed restoration tests trigger immediate remediation"]},
  {t:"DR/BCP Test Results",type:"Record",fw:{"ISO 27001":["A.17.1.3"],"HIPAA":["§164.308(a)(7)(ii)(D)"],"SOC 2":["A1.3"],"NIST CSF":["PR.IP-10"]},reqs:["DR/BCP test conducted at least annually","Test scenario, scope, and participants are documented","Results measured against success criteria and RTO/RPO","Lessons learned are recorded and plan is updated","Test report is reviewed and approved by management"]},
  {t:"Terminated User Access Removal Evidence",type:"Record",fw:{"ISO 27001":["A.7.3.1"],"HIPAA":["§164.308(a)(3)(ii)(C)"],"PCI DSS":["Req 8.1"],"CMMC":["PS.L2-3.9.2"]},reqs:["Access removed within 24 hours of termination date","All systems, applications, and physical access are revoked","Removal is verified and documented with timestamps","Shared or service account password changes are triggered","Removal records are retained for audit review"]},
  {t:"Security Metrics & KPI Reports",type:"Record",fw:{"ISO 27001":["A.18.2.2"],"SOC 2":["CC4.1"],"NIST CSF":["DE.DP-5"]},reqs:["Metrics collected and reported at least quarterly","Key areas covered include incidents, vulnerabilities, and compliance","Trends are tracked over time with visual dashboards","Reports are distributed to senior management","Targets and thresholds are defined for each KPI"]},
  // ── LOGS & MONITORING EVIDENCE ──────────────────────────────────────
  {t:"Audit Log Samples",type:"Evidence",fw:{"PCI DSS":["Req 10.2"],"ISO 27001":["A.12.4.1"],"HIPAA":["§164.312(b)"],"CMMC":["AU.L2-3.3.1"]},reqs:["Logs capture user activity, access events, and system changes","Log entries include timestamp, user ID, action, and result","Logs retained for minimum of 1 year (3 months immediately available)","Log integrity protection mechanisms are in place","Sample logs are available for the full audit period"]},
  {t:"SIEM / Security Monitoring Evidence",type:"Evidence",fw:{"PCI DSS":["Req 10.4"],"ISO 27001":["A.12.4.1"],"SOC 2":["CC7.2"],"NIST CSF":["DE.AE-3"]},reqs:["Centralized log management or SIEM solution is deployed","Alerting rules are configured for key security events","Alerts are reviewed and triaged within defined timeframes","24/7 monitoring or after-hours coverage is documented","SIEM dashboards and correlation rules are maintained"]},
  {t:"Firewall Rule Review Evidence",type:"Evidence",fw:{"PCI DSS":["Req 1.2"],"ISO 27001":["A.13.1.1"],"CMMC":["SC.L2-3.13.1"]},reqs:["Firewall rules reviewed at least every 6 months","Unused, expired, or overly permissive rules are removed","Default deny-all rule is in place on all firewalls","Review sign-off by network security owner is documented","Rule change history is maintained and auditable"]},
  {t:"Access Log Samples",type:"Evidence",fw:{"HIPAA":["§164.312(b)"],"PCI DSS":["Req 10.2"],"ISO 27001":["A.12.4.1"],"CMMC":["AU.L2-3.3.1"]},reqs:["Successful and failed login attempts are captured","Privileged access activity is logged separately","Log samples are available for the complete audit period","Logs include source IP, timestamp, and user identity","Anomalous access patterns are flagged for review"]},
  // ── TECHNICAL CONFIGURATION EVIDENCE ────────────────────────────────
  {t:"System Hardening Evidence (CIS Benchmarks)",type:"Evidence",fw:{"PCI DSS":["Req 2.2"],"ISO 27001":["A.12.1.1"],"CMMC":["CM.L2-3.4.6"]},reqs:["Hardening standards applied to all in-scope systems","CIS Benchmark or equivalent standard is used as baseline","Compliance scan results are available for audit review","Deviations are documented and approved by management","Hardening evidence is refreshed at least quarterly"]},
  {t:"MFA Configuration Evidence",type:"Evidence",fw:{"PCI DSS":["Req 8.4"],"NIST CSF":["PR.AC-7"],"CMMC":["IA.L2-3.5.3"],"ISO 27001":["A.9.4.2"]},reqs:["MFA enabled for all remote access connections","MFA required for all admin and privileged accounts","MFA technology and supported methods are documented","Configuration screenshots or exports are available","MFA bypass or exception processes are documented"]},
  {t:"Encryption-at-Rest Configuration Evidence",type:"Evidence",fw:{"PCI DSS":["Req 3.5"],"HIPAA":["§164.312(a)(2)(iv)"],"ISO 27001":["A.10.1.1"],"CMMC":["SC.L2-3.13.11"]},reqs:["Encryption enabled for all sensitive data stores","AES-256 or equivalent algorithm is used","Key management procedures are followed and documented","Configuration screenshots or audit exports are available","Unencrypted sensitive data stores are documented as exceptions"]},
  {t:"Encryption-in-Transit Configuration Evidence",type:"Evidence",fw:{"PCI DSS":["Req 4.2"],"HIPAA":["§164.312(e)(2)(ii)"],"ISO 27001":["A.10.1.1"],"CMMC":["SC.L2-3.13.8"]},reqs:["TLS 1.2 or higher enforced on all connections","SSL/TLS certificate inventory is maintained","Weak ciphers and protocols are disabled","Configuration evidence from servers and load balancers is available","Certificate expiration monitoring is in place"]},
  {t:"Endpoint Protection Configuration Evidence",type:"Evidence",fw:{"ISO 27001":["A.12.2.1"],"PCI DSS":["Req 5.2"],"CMMC":["SI.L2-3.14.2"]},reqs:["Antivirus or EDR deployed on all endpoints","Real-time scanning is enabled and active","Signature and definition updates are automated","Central management console screenshots are available","Unprotected endpoints are documented as exceptions with mitigations"]},
  {t:"Account Lockout & Password Configuration",type:"Evidence",fw:{"PCI DSS":["Req 8.3"],"HIPAA":["§164.308(a)(5)(ii)(D)"],"ISO 27001":["A.9.4.3"],"CMMC":["IA.L2-3.5.7"]},reqs:["Account lockout after defined number of failed attempts","Minimum password complexity requirements are enforced","Password expiration or rotation policy is configured","Configuration screenshots from directory services are available","Password history prevents reuse of recent passwords"]},
  ...
  // ── REGISTERS & LOGS ────────────────────────────────────────────────
  {t:"Incident Register / Security Incident Log",type:"Register",fw:{"ISO 27001":["A.16.1.5"],"SOC 2":["CC7.3"],"HIPAA":["§164.308(a)(6)(i)"],"PCI DSS":["Req 12.10"],"NIST CSF":["RS.AN-4"],"CMMC":["IR.L2-3.6.2"]},reqs:["All security incidents logged with date, description, and severity","Response actions and timelines are documented per incident","Root cause analysis is performed for significant incidents","Lessons learned are recorded and fed back into controls","Incident register is reviewed by management at least quarterly"]},
  ...
  {t:"Plan of Action & Milestones (POA&M)",type:"Register",fw:{"CMMC":["CA.L2-3.12.2"],"NIST CSF":["ID.RA-6"]},reqs:["All open findings tracked with responsible party assigned","Planned completion dates are set for each item","Milestones defined for long-term remediation items","POA&M is reviewed and updated at least monthly","Status and progress are reported to management"]},
